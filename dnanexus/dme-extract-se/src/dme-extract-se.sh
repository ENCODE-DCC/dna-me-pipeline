...
main() {
    ...
    CpG_bed=$(dx upload ${target_root}_CpG.bed.gz --property SW="$versions" --brief)
    CHG_bed=$(dx upload ${target_root}_CHG.bed.gz --property SW="$versions" --brief)
    CHH_bed=$(dx upload ${target_root}_CHH.bed.gz --property SW="$versions" --brief)

    CpG_bb=$(dx upload ${target_root}_CpG.bb --property SW="$versions" --brief)
    CHG_bb=$(dx upload ${target_root}_CHG.bb --property SW="$versions" --brief)
    CHH_bb=$(dx upload ${target_root}_CHH.bb --property SW="$versions" --brief)

...
def bismark_full_extract(target_root, alignments, ncores):
    ...
    cmd = 'bismark_methylation_extractor --multicore %d --paired-end -s --comprehensive --cytosine_report ' % (ncores)
...
def signal_io(bedgraph_gz_dxlink, chrom_sizes_dxlink, target_root, qc_metrics, props):
    ...
    bigWig_dxfile = dxpy.upload_local_file(bigWig,properties=props,details=qc_metrics,cleanup=True)
